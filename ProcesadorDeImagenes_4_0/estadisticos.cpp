...
map<int,int> Estadisticos::Hist_intensidad()
{
   ...
   for(auto &x: Vec )
    {
        histo_intensidad[x.intensidad()]=histo_intensidad[x.intensidad()]+1;//key intensidad, value frecuencia
   }

   auto max_it = max_element(histo_intensidad.begin(), histo_intensidad.end(),
...
map<int,int> Estadisticos::Hist_R()
{
        ...
        auto max_it = max_element(histo_R.begin(), histo_R.end(),
                [](const pair<int, int>& p1, const pair<int, int>& p2) {
                    return p1.second < p2.second;
                });
...
map<int,int> Estadisticos::Hist_G()
{
    ...
    auto max_it = max_element(histo_G.begin(), histo_G.end(),
            [](const pair<int, int>& p1, const pair<int, int>& p2) {
                return p1.second < p2.second;
            });
...
map<int,int> Estadisticos::Hist_B()
{
    ...
    auto max_it = max_element(histo_B.begin(), histo_B.end(),
            [](const pair<int, int>& p1, const pair<int, int>& p2) {
                return p1.second < p2.second;
            });
